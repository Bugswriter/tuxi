...
printf "Testing Weather¬\n" && ./tuxi "how hot is it in india?" 1>>testoutputs.txt && printf "\tpassed.\n" || printf "\tFailed...\n"
printf "Testing Weather¬\n" && ./tuxi "how cold is it in alaska?" 1>>testoutputs.txt && printf "\tpassed.\n" || printf "\tFailed...\n"
printf "Testing Weather¬\n" && ./tuxi "temp of mexico right now?" 1>>testoutputs.txt && printf "\tpassed.\n" || printf "\tFailed...\n"
printf "Testing Weather¬\n" && ./tuxi "how cold is it in canada right now?" 1>>testoutputs.txt && printf "\tpassed.\n" || printf "\tFailed...\n"


printf "Testing Knowledge Graph - right¬\n" && ./tuxi "lorem ipsum" 1>>testoutputs.txt && printf "\tpassed.\n" || printf "\tFailed...\n"
printf "Testing Knowledge Graph - right¬\n" && ./tuxi "the office" 1>>testoutputs.txt && printf "\tpassed.\n" || printf "\tFailed...\n"
printf "Testing Knowledge Graph - right¬\n" && ./tuxi "what is a firefighter" 1>>testoutputs.txt && printf "\tpassed.\n" || printf "\tFailed...\n"
printf "Testing Knowledge Graph - right¬\n" && ./tuxi "what is the american bill of rights" 1>>testoutputs.txt && printf "\tpassed.\n" || printf "\tFailed...\n"
########################################
